...
import { Check, Search } from "@honeyicons/react";
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      <DialogContent
        className={cn("overflow-hidden rounded-3xl! p-0", className)}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 rounded-full pb-0">
