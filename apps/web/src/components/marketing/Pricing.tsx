...
const PricingCard = ({
  ...
  <div
    className={`marketing-surface flex h-full flex-col border bg-surface p-5 text-foreground ${
      plan.preferred ? "border-accent" : "border-border/50"
    }`}
  >
    <div className="flex min-h-30 flex-col items-start gap-3">
      {plan.badge && (
        <span
    ...
    <div className="mt-5 flex items-end gap-1 border-b border-border pb-5">
